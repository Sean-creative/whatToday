		...
		<div class="section_in">
			...
			<form action="/thunder/add" method="post" id="tag-form" enctype="multipart/form-data">
				...
				<fieldset class="formContent">
					...
					<div class="request">
						<label for="request" class="class">모임 인원*</label>
					...
					<div class="request">
						<label for="request" class="class">해시태그</label>
					...
					<div class="request">
						<label for="request" class="class">모임 준비물</label>
					...
					<div class="request">
						<label for="request" class="class">모임소개</label>
